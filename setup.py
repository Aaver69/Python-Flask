...
includes = ["run.py", "setup.py"]  # nommer les modules non trouves par cx_freeze
excludes = []
packages = []  # nommer les packages utilises

# copier les fichiers non-Python et/ou repertoires et leur contenu:
includefiles = ["src", "static", "README.MD", "requirement.txt"]
...
setup(
    name="InterfaceCli",
    version="0.0.1",
    description="InterfaceCli is a program which manipulate files and path through a web fridenly user interface",
    author="Axel Masson         ",
